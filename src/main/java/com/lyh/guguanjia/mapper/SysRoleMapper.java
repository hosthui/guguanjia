...
public interface SysRoleMapper extends Mapper<SysRole> {
	...
	int insertBatchByOffice(@Param("roleId") Long roleId, @Param("oid") List<Integer> oid);
	...
	int insertBatchByResource(@Param("roleId") Long roleId, @Param("rid") List<Integer> rid);

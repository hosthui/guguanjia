...
public class FTPUtil {
    ...
    public static void main(String[] args) {
        ...
        FTPClient ftp = test.getFTPClient("192.168.1.125", 21, "user","user");
        //test.downLoadFTP(ftp, "/file", "你好.jpg", "C:\\下载");
        //test.copyFile(ftp, "/file", "/txt/temp", "你好.txt");
        test.uploadFile(ftp, "G:\\课件\\【Shiro】\\其它\\Shiro-04-springboot\\src\\main\\resources\\static\\images\\icon_right_s.png", "/uploads");

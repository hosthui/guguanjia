...
public class Qualification {
	...
	public String toString() {
		return "Qualification{" + "id=" + id + ", uploadUserId=" + uploadUserId + ", type=" + type + ", address='" + address + '\'' + ", check=" + check + ", description='" + description + '\'' + ", checkUserId=" + checkUserId + ", createDate=" + createDate + ", updateDate=" + updateDate + ", delFlag='" + delFlag + '\'' + ", createBy='" + createBy + '\'' + ", uploadUsername='" + uploadUsername + '\'' + ", checkUsername='" + checkUsername + '\'' + '}';
	}

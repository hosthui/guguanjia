...
public class WorkOrder {
    ...
    @Transient
    private String transportUerName;
	...
	public String getTransportUerName() {
		return transportUerName;
	}

	public void setTransportUerName(String transportUerName) {
		this.transportUerName = transportUerName;
	}

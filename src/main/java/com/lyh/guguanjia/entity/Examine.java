...
public class Examine {
	...
	public String toString() {
		return "Examine{" + "id=" + id + ", examineUserId=" + examineUserId + ", score=" + score + ", scoreInfo='" + scoreInfo + '\'' + ", type=" + type + ", createDate=" + createDate + ", updateDate=" + updateDate + ", delFlag='" + delFlag + '\'' + ", createBy='" + createBy + '\'' + ", username='" + username + '\'' + ", officename='" + officename + '\'' + '}';
	}
